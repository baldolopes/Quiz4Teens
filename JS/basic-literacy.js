...
(function() {
    ...
    // --- Quiz Data ---
    const quizData = [
        { question: "Scotland's national animal?", options: ["a) Dragon", "b) Unicorn", "c) Horse", "d) Cat"], correctAnswer: "b) Unicorn" },
        { question: "What is a 'Loch'?", options: ["a) Lake", "b) River", "c) Sea", "d) Forest"], correctAnswer: "a) Lake" },
        { question: "Who wrote 'To a Mouse'?", options: ["a) Robert Burns", "b) Walter Scott", "c) J. K. Rowling", "d) William Wallace"], correctAnswer: "a) Robert Burns" },
        { question: "What is the Capital of Scotland?", options: ["a) Glasgow", "b) Dundee", "c) Inverness", "d) Edinburgh"], correctAnswer: "d) Edinburgh" },
        { question: "What is 'Ceilidh'?", options: ["a) A poem", "b) A dance party", "c) A Castle", "d) A mountain"], correctAnswer: "b) A dance party" }
    ];
